...
export const languages = {
  aa: { order:   1, iso_639_1: 'aa', name: 'Afar',        label: 'Qafár af' },
  ab: { order:   2, iso_639_1: 'ab', name: 'Abkhazian',   label: 'Аҧсуа' },
  ae: { order:   3, iso_639_1: 'ae', name: 'Avestan',     label: 'Avesta', type: 'H' },
  af: { order:   4, iso_639_1: 'af', name: 'Afrikaans',   label: 'Afrikaans' },
  ak: { order:   5, iso_639_1: 'ak', name: 'Akan',        label: 'Akana' },
  am: { order:   6, iso_639_1: 'am', name: 'Amharic',     label: 'አማርኛ' },
  an: { order:   7, iso_639_1: 'an', name: 'Aragonese',   label: 'Aragonés' },
  ar: { order:   8, iso_639_1: 'ar', name: 'Arabic',      label: 'العربية' },
  as: { order:   9, iso_639_1: 'as', name: 'Assamese',    label: 'অসমীয়া' },
  av: { order:  10, iso_639_1: 'av', name: 'Avaric',      label: 'Авар' },
  ay: { order:  11, iso_639_1: 'ay', name: 'Aymara',      label: 'Aymar' },
  az: { order:  12, iso_639_1: 'az', name: 'Azerbaijani', label: 'Azərbaycanca' },
  ba: { order:  13, iso_639_1: 'ba', name: 'Bashkir',     label: 'Bashkort' },
  be: { order:  14, iso_639_1: 'be', name: 'Belarusian',  label: 'Беларуская' },
  bg: { order:  15, iso_639_1: 'bg', name: 'Bulgarian',   label: 'Български' },
  bi: { order:  16, iso_639_1: 'bi', name: 'Bislama',     label: 'Bislama' },
  bm: { order:  17, iso_639_1: 'bm', name: 'Bambara',     label: 'Bamanankan' },
  bn: { order:  18, iso_639_1: 'bn', name: 'Bengali',     label: 'বাংলা' },
  bo: { order:  19, iso_639_1: 'bo', name: 'Tibetan',     label: 'བོད་ཡིག' },
  br: { order:  20, iso_639_1: 'br', name: 'Breton',      label: 'Brezhoneg' },
  bs: { order:  21, iso_639_1: 'bs', name: 'Bosnian',     label: 'Bosanski' },
  ca: { order:  22, iso_639_1: 'ca', name: 'Catalan',     label: 'Català' },
  ce: { order:  23, iso_639_1: 'ce', name: 'Chechen',     label: 'Нохчийн' },
  ch: { order:  24, iso_639_1: 'ch', name: 'Chamorro',    label: 'Chamoru' },
  co: { order:  25, iso_639_1: 'co', name: 'Corsican',    label: 'Corsu' },
  cr: { order:  26, iso_639_1: 'cr', name: 'Cree',        label: 'Nehiyawewin' },
  cs: { order:  27, iso_639_1: 'cs', name: 'Czech',       label: 'Čeština' },
  cu: { order:  28, iso_639_1: 'cu', name: 'Church Slavic',    label: 'Словѣньскъ', type: 'H' },
  cv: { order:  29, iso_639_1: 'cv', name: 'Chuvash',     label: 'Чӑваш' },
  cy: { order:  30, iso_639_1: 'cy', name: 'Welsh',       label: 'Cymraeg' },
  da: { order:  31, iso_639_1: 'da', name: 'Danish',      label: 'Dansk' },
  de: { order:  32, iso_639_1: 'de', name: 'German',      label: 'Deutsch' },
  dv: { order:  33, iso_639_1: 'dv', name: 'Divehi',      label: 'ދިވެހިބަސް' },
  dz: { order:  34, iso_639_1: 'dz', name: 'Dzongkha',    label: 'རྫོང་ཁ' },
  ee: { order:  35, iso_639_1: 'ee', name: 'Ewe',         label: 'Eʋegbe' },
  el: { order:  36, iso_639_1: 'el', name: 'Greek',       label: 'Ελληνικά' },
  en: { order:  37, iso_639_1: 'en', name: 'English',     label: 'English' },
  eo: { order:  38, iso_639_1: 'eo', name: 'Esperanto',   label: 'Esperanto', type: 'C' },
  es: { order:  39, iso_639_1: 'es', name: 'Spanish',     label: 'Español' },
  et: { order:  40, iso_639_1: 'et', name: 'Estonian',    label: 'Eesti' },
  eu: { order:  41, iso_639_1: 'eu', name: 'Basque',      label: 'Euskara' },
  fa: { order:  42, iso_639_1: 'fa', name: 'Persian',     label: 'فارسی' },
  ff: { order:  43, iso_639_1: 'ff', name: 'Fulah',       label: 'Fulfulde' },
  fi: { order:  44, iso_639_1: 'fi', name: 'Finnish',     label: 'Suomi' },
  fj: { order:  45, iso_639_1: 'fj', name: 'Fijian',      label: 'Na Vosa Vakaviti' },
  fo: { order:  46, iso_639_1: 'fo', name: 'Faroese',     label: 'Føroyskt' },
  fr: { order:  47, iso_639_1: 'fr', name: 'French',      label: 'Français' },
  fy: { order:  48, iso_639_1: 'fy', name: 'Western Frisian',  label: 'Frysk' },
  ga: { order:  49, iso_639_1: 'ga', name: 'Irish',       label: 'Gaeilge' },
  gd: { order:  50, iso_639_1: 'gd', name: 'Gaelic',      label: 'Gàidhlig' },
  gl: { order:  51, iso_639_1: 'gl', name: 'Galician',    label: 'Galego' },
  gn: { order:  52, iso_639_1: 'gn', name: 'Guarani',     label: 'Avañe\'ẽ' },
  gu: { order:  53, iso_639_1: 'gu', name: 'Gujarati',    label: 'ગુજરાતી' },
  gv: { order:  54, iso_639_1: 'gv', name: 'Manx',        label: 'Gaelg' },
  ha: { order:  55, iso_639_1: 'ha', name: 'Hausa',       label: 'هَوُسَ' },
  he: { order:  56, iso_639_1: 'he', name: 'Hebrew',      label: 'עברית' },
  hi: { order:  57, iso_639_1: 'hi', name: 'Hindi',       label: 'हिन्दी' },
  ho: { order:  58, iso_639_1: 'ho', name: 'Hiri Motu',   label: 'Hiri Motu' },
  hr: { order:  59, iso_639_1: 'hr', name: 'Croatian',    label: 'Hrvatski' },
  ht: { order:  60, iso_639_1: 'ht', name: 'Haitian',     label: 'Kreyòl ayisyen' },
  hu: { order:  61, iso_639_1: 'hu', name: 'Hungarian',   label: 'Magyar' },
  hy: { order:  62, iso_639_1: 'hy', name: 'Armenian',    label: 'Հայերեն' },
  hz: { order:  63, iso_639_1: 'hz', name: 'Herero',      label: 'Otjiherero' },
  ia: { order:  64, iso_639_1: 'ia', name: 'Interlingua', label: 'Interlingua', type: 'C' },
  id: { order:  65, iso_639_1: 'id', name: 'Indonesian',  label: 'Bahasa Indonesia' },
  ie: { order:  66, iso_639_1: 'ie', name: 'Interlingue', label: 'Interlingue', type: 'C' },
  ig: { order:  67, iso_639_1: 'ig', name: 'Igbo',        label: 'Asụsụ Igbo' },
  ii: { order:  68, iso_639_1: 'ii', name: 'Sichuan Yi',  label: 'ꆈꌠ꒿' },
  ik: { order:  69, iso_639_1: 'ik', name: 'Inupiaq',     label: 'Iñupiaq' },
  io: { order:  70, iso_639_1: 'io', name: 'Ido',         label: 'Ido', type: 'C' },
  is: { order:  71, iso_639_1: 'is', name: 'Icelandic',   label: 'Íslenska' },
  it: { order:  72, iso_639_1: 'it', name: 'Italian',     label: 'Italiano' },
  iu: { order:  73, iso_639_1: 'iu', name: 'Inuktitut',   label: 'ᐃᓄᒃᑎᑐᑦ' },
  ja: { order:  74, iso_639_1: 'ja', name: 'Japanese',    label: '日本語' },
  jv: { order:  75, iso_639_1: 'jv', name: 'Javanese',    label: 'Basa Jawa' },
  ka: { order:  76, iso_639_1: 'ka', name: 'Georgian',    label: 'ქართული' },
  kg: { order:  77, iso_639_1: 'kg', name: 'Kongo',       label: 'Kikongo' },
  ki: { order:  78, iso_639_1: 'ki', name: 'Kikuyu',      label: 'Gĩkũyũ' },
  kj: { order:  79, iso_639_1: 'kj', name: 'Kuanyama',    label: 'Kuanyama' },
  kk: { order:  80, iso_639_1: 'kk', name: 'Kazakh',      label: 'Қазақша' },
  kl: { order:  81, iso_639_1: 'kl', name: 'Kalaallisut', label: 'Kalaallisut' },
  km: { order:  82, iso_639_1: 'km', name: 'Khmer',       label: 'ភាសាខ្មဲរ' },
  kn: { order:  83, iso_639_1: 'kn', name: 'Kannada',     label: 'ಕನ್ನಡ' },
  ko: { order:  84, iso_639_1: 'ko', name: 'Korean',      label: '한국어' },
  kr: { order:  85, iso_639_1: 'kr', name: 'Kanuri',      label: 'Kanuri' },
  ks: { order:  86, iso_639_1: 'ks', name: 'Kashmiri',    label: 'कश्मीरी' },
  ku: { order:  87, iso_639_1: 'ku', name: 'Kurdish',     label: 'Kurdî' },
  kv: { order:  88, iso_639_1: 'kv', name: 'Komi',        label: 'Коми' },
  kw: { order:  89, iso_639_1: 'kw', name: 'Cornish',     label: 'Kernewek' },
  ky: { order:  90, iso_639_1: 'ky', name: 'Kirghiz',     label: 'Кыргызча' },
  la: { order:  91, iso_639_1: 'la', name: 'Latin',       label: 'Latina', type: 'H' },
  lb: { order:  92, iso_639_1: 'lb', name: 'Luxembourgish', label: 'Lëtzebuergesch' },
  lg: { order:  93, iso_639_1: 'lg', name: 'Ganda',         label: 'Luganda' },
  li: { order:  94, iso_639_1: 'li', name: 'Limburgish',    label: 'Limburgs' },
  ln: { order:  95, iso_639_1: 'ln', name: 'Lingala',       label: 'Lingála' },
  lo: { order:  96, iso_639_1: 'lo', name: 'Lao',           label: 'ພາສາລາວ' },
  lt: { order:  97, iso_639_1: 'lt', name: 'Lithuanian',    label: 'Lietuvių' },
  lu: { order:  98, iso_639_1: 'lu', name: 'Luba-Katanga',  label: 'Tshiluba' },
  lv: { order:  99, iso_639_1: 'lv', name: 'Latvian',       label: 'Latviešu' },
  mg: { order: 100, iso_639_1: 'mg', name: 'Malagasy',     label: 'Malagasy' },
  mh: { order: 101, iso_639_1: 'mh', name: 'Marshallese',  label: 'Kajin M̧ajeļ' },
  mi: { order: 102, iso_639_1: 'mi', name: 'Maori',        label: 'Te Reo Māori' },
  mk: { order: 103, iso_639_1: 'mk', name: 'Macedonian',   label: 'Македонски' },
  ml: { order: 104, iso_639_1: 'ml', name: 'Malayalam',    label: 'മലയാളം' },
  mn: { order: 105, iso_639_1: 'mn', name: 'Mongolian',    label: 'Монгол' },
  mr: { order: 106, iso_639_1: 'mr', name: 'Marathi',      label: 'मराठी' },
  ms: { order: 107, iso_639_1: 'ms', name: 'Malay',        label: 'Bahasa Melayu' },
  mt: { order: 108, iso_639_1: 'mt', name: 'Maltese',      label: 'Malti' },
  my: { order: 109, iso_639_1: 'my', name: 'Burmese',      label: 'ဗမာစာ' },
  na: { order: 110, iso_639_1: 'na', name: 'Nauru',        label: 'Ekakairũ Naoero' },
  nb: { order: 111, iso_639_1: 'nb', name: 'Bokmål, Norwegian',  label: 'Norsk bokmål' },
  nd: { order: 112, iso_639_1: 'nd', name: 'North Ndebele',      label: 'isiNdebele' },
  ne: { order: 113, iso_639_1: 'ne', name: 'Nepali',       label: 'नेपाली' },
  ng: { order: 114, iso_639_1: 'ng', name: 'Ndonga',       label: 'Owambo' },
  nl: { order: 115, iso_639_1: 'nl', name: 'Dutch',        label: 'Nederlands' },
  nn: { order: 116, iso_639_1: 'nn', name: 'Norwegian Nynorsk',  label: 'Norsk nynorsk' },
  no: { order: 117, iso_639_1: 'no', name: 'Norwegian',    label: 'Norsk' },
  nr: { order: 118, iso_639_1: 'nr', name: 'South Ndebele',      label: 'isiNdebele' },
  nv: { order: 119, iso_639_1: 'nv', name: 'Navajo',       label: 'Diné bizaad' },
  ny: { order: 120, iso_639_1: 'ny', name: 'Chichewa',     label: 'Chi-Chewa' },
  oc: { order: 121, iso_639_1: 'oc', name: 'Occitan',      label: 'Occitan' },
  oj: { order: 122, iso_639_1: 'oj', name: 'Ojibwa',       label: 'ᐊᓂᔑᓈᐯᒧ win' },
  om: { order: 123, iso_639_1: 'om', name: 'Oromo',        label: 'Afaan Oromoo' },
  or: { order: 124, iso_639_1: 'or', name: 'Oriya',        label: 'ଓଡ଼ିଆ' },
  os: { order: 125, iso_639_1: 'os', name: 'Ossetian',     label: 'Ирон' },
  pa: { order: 126, iso_639_1: 'pa', name: 'Panjabi',      label: 'ਪੰਜਾਬੀ' },
  pi: { order: 127, iso_639_1: 'pi', name: 'Pali',         label: 'पाळि', type: 'H' },
  pl: { order: 128, iso_639_1: 'pl', name: 'Polish',       label: 'Polski' },
  ps: { order: 129, iso_639_1: 'ps', name: 'Pashto',       label: 'پښتو' },
  pt: { order: 130, iso_639_1: 'pt', name: 'Portuguese',   label: 'Português' },
  qu: { order: 131, iso_639_1: 'qu', name: 'Quechua',      label: 'Runa Simi' },
  rm: { order: 132, iso_639_1: 'rm', name: 'Romansh',      label: 'Rumantsch' },
  rn: { order: 133, iso_639_1: 'rn', name: 'Rundi',        label: 'Kirundi' },
  ro: { order: 134, iso_639_1: 'ro', name: 'Romanian',     label: 'Română' },
  ru: { order: 135, iso_639_1: 'ru', name: 'Russian',      label: 'Русский' },
  rw: { order: 136, iso_639_1: 'rw', name: 'Kinyarwanda',  label: 'Ikinyarwanda' },
  sa: { order: 137, iso_639_1: 'sa', name: 'Sanskrit',     label: 'संस्कृतम्', type: 'H' },
  sc: { order: 138, iso_639_1: 'sc', name: 'Sardinian',    label: 'Sardu' },
  sd: { order: 139, iso_639_1: 'sd', name: 'Sindhi',       label: 'سنڌي' },
  se: { order: 140, iso_639_1: 'se', name: 'Northern Sami',   label: 'Davvisámegiella' },
  sg: { order: 141, iso_639_1: 'sg', name: 'Sango',        label: 'Yângâ tî Sängö' },
  si: { order: 142, iso_639_1: 'si', name: 'Sinhala',      label: 'සිංහල' },
  sk: { order: 143, iso_639_1: 'sk', name: 'Slovak',       label: 'Slovenčina' },
  sl: { order: 144, iso_639_1: 'sl', name: 'Slovenian',    label: 'Slovenščina' },
  sm: { order: 145, iso_639_1: 'sm', name: 'Samoan',       label: 'Gagana fa\'a Samoa' },
  sn: { order: 146, iso_639_1: 'sn', name: 'Shona',        label: 'chiShona' },
  so: { order: 147, iso_639_1: 'so', name: 'Somali',       label: 'Soomaaliga' },
  sq: { order: 148, iso_639_1: 'sq', name: 'Albanian',     label: 'Shqip' },
  sr: { order: 149, iso_639_1: 'sr', name: 'Serbian',      label: 'Српски' },
  ss: { order: 150, iso_639_1: 'ss', name: 'Swati',        label: 'SiSwati' },
  st: { order: 151, iso_639_1: 'st', name: 'Southern Sotho',  label: 'Sesotho' },
  su: { order: 152, iso_639_1: 'su', name: 'Sundanese',    label: 'Basa Sunda' },
  sv: { order: 153, iso_639_1: 'sv', name: 'Swedish',      label: 'Svenska' },
  sw: { order: 154, iso_639_1: 'sw', name: 'Swahili',      label: 'Kiswahili' },
  ta: { order: 155, iso_639_1: 'ta', name: 'Tamil',        label: 'தமிழ்' },
  te: { order: 156, iso_639_1: 'te', name: 'Telugu',       label: 'తెలుగు' },
  tg: { order: 157, iso_639_1: 'tg', name: 'Tajik',        label: 'Тоҷикӣ' },
  th: { order: 158, iso_639_1: 'th', name: 'Thai',         label: 'ไทย' },
  ti: { order: 159, iso_639_1: 'ti', name: 'Tigrinya',     label: 'ትግርኛ' },
  tk: { order: 160, iso_639_1: 'tk', name: 'Turkmen',      label: 'Türkmençe' },
  tl: { order: 161, iso_639_1: 'tl', name: 'Tagalog',      label: 'Tagalog' },
  tn: { order: 162, iso_639_1: 'tn', name: 'Tswana',       label: 'Setswana' },
  to: { order: 163, iso_639_1: 'to', name: 'Tonga',        label: 'Faka Tonga' },
  tr: { order: 164, iso_639_1: 'tr', name: 'Turkish',      label: 'Türkçe' },
  ts: { order: 165, iso_639_1: 'ts', name: 'Tsonga',       label: 'Xitsonga' },
  tt: { order: 166, iso_639_1: 'tt', name: 'Tatar',        label: 'Татарча' },
  tw: { order: 167, iso_639_1: 'tw', name: 'Twi',          label: 'Twi' },
  ty: { order: 168, iso_639_1: 'ty', name: 'Tahitian',     label: 'Reo Māohi' },
  ug: { order: 169, iso_639_1: 'ug', name: 'Uighur',       label: 'ئۇيغۇرچە' },
  uk: { order: 170, iso_639_1: 'uk', name: 'Ukrainian',    label: 'Українська' },
  ur: { order: 171, iso_639_1: 'ur', name: 'Urdu',         label: 'اردو' },
  uz: { order: 172, iso_639_1: 'uz', name: 'Uzbek',        label: 'Oʻzbekcha' },
  ve: { order: 173, iso_639_1: 've', name: 'Venda',        label: 'Tshivenda' },
  vi: { order: 174, iso_639_1: 'vi', name: 'Vietnamese',   label: 'Tiếng Việt' },
  vo: { order: 175, iso_639_1: 'vo', name: 'Volapük',      label: 'Volapük', type: 'C' },
  wa: { order: 176, iso_639_1: 'wa', name: 'Walloon',      label: 'Walon' },
  wo: { order: 177, iso_639_1: 'wo', name: 'Wolof',        label: 'Wollof' },
  xh: { order: 178, iso_639_1: 'xh', name: 'Xhosa',        label: 'isiXhosa' },
  yi: { order: 179, iso_639_1: 'yi', name: 'Yiddish',      label: 'ייִדיש' },
  yo: { order: 180, iso_639_1: 'yo', name: 'Yoruba',       label: 'Yorùbá' },
  za: { order: 181, iso_639_1: 'za', name: 'Zhuang',       label: 'Saɯ cueŋƅ' },
  zh: { order: 182, iso_639_1: 'zh', name: 'Chinese',      label: '中文' },
  zu: { order: 183, iso_639_1: 'zu', name: 'Zulu',         label: 'isiZulu' }
};
...
export const iso_639_3166 = {
  "en-AU": { order: 0, key: "en-AU", name: "English (Australia)", label: "English (Australia)" },
  "en-CA": { order: 0, key: "en-CA", name: "English (Canada)", label: "English (Canada)" },
  "en-GB": { order: 0, key: "en-GB", name: "English (UK)", label: "English (United Kingdom)" },
  "en-IE": { order: 0, key: "en-IE", name: "English (Ireland)", label: "English (Ireland)" },
  "en-IN": { order: 0, key: "en-IN", name: "English (India)", label: "English (India)" },
  "en-NG": { order: 0, key: "en-NG", name: "English (Nigeria)", label: "English (Nigeria)" },
  "en-NZ": { order: 0, key: "en-NZ", name: "English (New Zealand)", label: "English (New Zealand)" },
  "en-US": { order: 0, key: "en-US", name: "English (US)", label: "English (United States)" },
  "en-ZA": { order: 0, key: "en-ZA", name: "English (South Africa)", label: "English (South Africa)" },
  "fr-CA": { order: 0, key: "fr-CA", name: "French (Canada)", label: "Français (Canada)" },
  "fr-FR": { order: 0, key: "fr-FR", name: "French (France)", label: "Français (France)" },
  "es-ES": { order: 0, key: "es-ES", name: "Spanish (Spain)", label: "Español (España)" },
  "es-US": { order: 0, key: "es-US", name: "Spanish (US)", label: "Español (Estados Unidos)" },
  "zh-CN": { order: 0, key: "zh-CN", name: "Chinese (Simplified)", label: "简体中文 (中国)" },
  "zh-HK": { order: 0, key: "zh-HK", name: "Chinese (Hong Kong)", label: "繁體中文 (香港)" },
  "zh-MO": { order: 0, key: "zh-MO", name: "Chinese (Macau)", label: "繁體中文 (澳門)" },
  "zh-SG": { order: 0, key: "zh-SG", name: "Chinese (Singapore)", label: "简体中文 (新加坡)" },
  "zh-TW": { order: 0, key: "zh-TW", name: "Chinese (Taiwan)", label: "繁體中文 (台灣)" },
}
